...
echo "$SG_ADMIN_KSEYSTORE_B64" | base64 -D > "$ES_CONF_DIR/kirk.jks"
echo "$SG_KEYSTORE_B64" | base64 -D > "$ES_CONF_DIR/keystore.jks"
echo "$SG_TRUSTSTORE_B64" | base64 -D > "$ES_CONF_DIR/truststore.jks"
